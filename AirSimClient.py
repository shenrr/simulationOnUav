...
class AirSimClientBase:
    ...
    def confirmConnection(self):#确认连接
    ...
    def getCollisionInfo(self):
        return CollisionInfo.from_msgpack(self.client.call('getCollisionInfo'))#直接写远程调用名称
    ...
    def setCameraOrientation(self, camera_id, orientation):
        self.client.call('setCameraOrientation', camera_id, orientation)#全是client这套
...
class MultirotorClient(AirSimClientBase, object):
    ...
    # APIs for control
    def moveByAngle(self, pitch, roll, z, yaw, duration):#可用api
