...
def main():
	...
	with tf.device("/gpu:0"):
		choose = "2"#input("请输入使用的模式: (1 DDPG)")
			...
			if choose=="1":
				...
				while True:
					...
					if terminal:
						...
						print(" " * 80, end="\r")
						print(
							"episode {} finish, average reward: {:.5f}, total success: {} result: {} step: {}".format(e,																			  step_count).ljust(
								80, " "))
						episode_reward = 0
						step_count = 0
						e += 1
				...
				while True:
					...
					state = next_state
					step_count += 1
					print("episode {} finish, total success: {} step: {}".format(e, success, step_count))
