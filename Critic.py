...
class Critic:
    ...
    def target_net_evalInit(self, states, actions):
        imgs, dstates = states
    ...
    def eval_net_evalInit(self, states, actions):
        imgs, dstates = states
        dstates=dstates.reshape((1, 4))
        actions = actions.reshape((1, 2))
        imgs=imgs.reshape((1,64,64,1))
    ...
    def train(self, states, actions, td_target):
        ...
        print( "Loss value: {}".format(self.sess.run(self.loss, feed_dict=feed_dict)).ljust(20, " "))
